...
Inject `IPionexSharedApiClient` when a service needs multiple Pionex Shared API surfaces. It exposes `SpotRest`, `SpotSocket`. When the operation or transport is selected dynamically, use a typed capability descriptor:
