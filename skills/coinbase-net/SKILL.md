...
This skill targets `JKorf.Coinbase.Net` 4.5.0, the latest published stable release verified on 2026-08-24.

Install the exchange package:

```bash
dotnet add package JKorf.Coinbase.Net --version 4.5.0
```
