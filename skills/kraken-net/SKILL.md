...
This skill targets `KrakenExchange.Net` 8.4.0, the latest published stable release verified on 2026-08-24.

Install the package:

```bash
dotnet add package KrakenExchange.Net --version 8.4.0
```
